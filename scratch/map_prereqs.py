...
core_dir = "/home/mac/Projects/lern/content/physics/quantum_mechanics/prerequisites/core/"
...
adv_keywords = {
    ...
    "adv_combinatorics_of_indistinguishable_particles.typ": ["Bosons", "Fermions", "indistinguishable"],
...
for filename in files:
    ...
    if os.path.exists(os.path.join(questions_dir, filename.replace(".typ", ".json"))):
        ...
        if matched_prereqs:
            ...
            includes = "\n".join([f'#include "../prerequisites/core/{p}"' for p in matched_prereqs])

...
Express $d U, Q, W$ for each process. Indicate if work is performed on or by the gas.

#pagebreak()
#set page(width: a_width, margin: a_margin)
#set text(size: a_size)
Isothermal steps have $d U = 0$
#pagebreak()
Adiabatic steps have $d U = 0$
#pagebreak()
Isothermal steps have $Q = 0$
#pagebreak()
All steps have $d U = 0$
#pagebreak()
#include "../explanations/td_2025_08_u2.typ"
#pagebreak()

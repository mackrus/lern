...
- *Schrödinger Equation (1D):*
  $ -planck^2/(2m) dif^2 / (dif x^2) psi(x) + V(x)psi(x) = E psi(x) $
...
- *Normalization & Probability:*
  $ integral_(-infinity)^(infinity) |psi(x)|^2 dif x = 1 $
  $ P(a <= x <= b) = integral_a^b |psi(x)|^2 dif x $

- *Expectation Value & Uncertainty:*
  $ chevron.l Q chevron.r = integral_(-infinity)^(infinity) psi^*(x) hat(Q) psi(x) dif x $
